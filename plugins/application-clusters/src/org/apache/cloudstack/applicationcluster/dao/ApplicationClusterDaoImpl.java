...
public class ApplicationClusterDaoImpl extends GenericDaoBase<ApplicationClusterVO, Long> implements ApplicationClusterDao {
    ...
    @Override
    public List<ApplicationClusterVO> findContainerClustersToGarbageCollect() {
    ...
    @Override
    public List<ApplicationClusterVO> findContainerClustersInState(ApplicationCluster.State state) {
